      ...
      <div className="box">
        <div className="inner-box">
          <div className="forms-wrap">
            <form action="index.html"autoComplete="off" onSubmit={handlelogin}className="sign-in-form">
              <div className="logo">
              ...
              <div className="heading">
                ...
                <a href="#" className="toggle" onClick={toggle}>Sign up</a>
              </div>
            ...
            <form action="index.html" onSubmit={handlesignup}autoComplete="off" className="sign-up-form">
              <div className="logo">
                <img src="./img/logo.png" alt="Develoopers" />
                <h4>Develoopers</h4>
              </div>
              ...
              <div className="heading">
                ...
                <a href="#" className="toggle" onClick={toggle}>Sign in</a>
              </div>
