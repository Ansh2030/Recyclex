...
import mainpic from "../Images/landScape.png";

import abes from "../Images/Abes.jpg";
import a1 from "../Images/VIET.jpg";
import a2 from "../Images/Kiet.jpg";
import a3 from "../Images/AKGEC_1_0.png";
import a4 from "../Images/SIH_logo.webp";
import a5 from "../Images/IIT.png";
import a6 from "../Images/This_is_the_logo_of_NIT_Calicut.svg.png";
  ...
  return (
    ...
    <!-- "Turning Trash into Treasure: Where Innovation Meets Conservation" --> */}
          ...
          <div className="content-container">
            <div>
              ...
              <div className="content-quote-cont">
                <p className="quotes">
                  {" "}
                  E-waste, once discarded, now holds the potential to be reborn
                  as valuable components, exemplifying the inherent capacity for
                  renewal and transformation.In the world of electronics,
                  yesterday's trash becomes tomorrow's treasure through the
                  magic of e-waste recycling <span> Trash To Treasure</span>
                </p>
              </div>
            </div>
            ...
            <div className="content-2-cont">
              <div className="content-2">
                <p>
                  This platform is committed to aiding you in liberating
                  discarded electronics from harmful disposal practices and
                  promoting their responsible recycling, contributing to a
              ...
              <div className="explore-btn-cont">
                ...
                <a href="otherHTML/statistics.html">
                  <button className="blog-btn">Locate</button>
                </a>
              </div>
            </div>
          </div>
          ...
          <div className="illustration-cont">
            <div>
              <img src={mainpic} alt="" width="650px" height="800px" />
            </div>
          </div>
        </div>
        ...
        <div className="section-2">
          <div className="section-2-head-cont">
            <h2 className="section-2-head">
              Here Are Some Proven Ways To Care For Our Planet Through
              Responsible<span> E-WASTE MANAGEMENT</span>.
            </h2>
          </div>
          ...
          <div className="card-container">
            <div className="card card-1 appear">
              <div className="card-content-cont">
                ...
                <p className="card-text">
                  "Elevate Your E-Waste Experience: Discover the Marketplace for
            ...
            <div className="card card-2 appear">
              <div className="card-content-cont">
                ...
                <p className="card-text">
                  "Find Your Nearest E-Waste Facility: Easy, Quick,
                  Sustainable." <br />
                  <span className="link-cont">
                    <a href="#">Learn more</a>
                    <i className="fas fa-long-arrow-alt-right arrow"></i>
            ...
            <div className="card card-3 appear">
              <div className="card-content-cont">
                ...
                <p className="card-text">
                  "Upgrade Your Tech, Transform Your World: Seamless Old Device
                  Replacement." <br />
                  <span className="link-cont">
                    <a href="#">Learn more</a>
                    <i className="fas fa-long-arrow-alt-right arrow"></i>
            ...
            <div className="card card-4">
              <div className="card-content-cont">
                ...
                <p className="card-text">
                  "Educational Insights at Your Fingertips: Discover Informative
                  Pop-ups." <br />
                  <span className="link-cont">
                    <a href="#">Learn more</a>
                    <i className="fas fa-long-arrow-alt-right arrow"></i>
          ...
          <div className="take-page-content-cont">
            <div className="talk-page-content">
              <div>
                ...
                {/* <!-- <h2></> --> */}
                <p>
                  RecycleX team believes that achieving a waste-free India is an
                  ambitious yet attainable goal. We firmly believe that every
                  small step towards this objective counts. We are delighted to
                  see the growing popularity of the zero waste philosophy across
                  the country. Let's learn about zero waste together and work
                  hand in hand to create a better India.
                </p>

                <p>
                  Talking can be a way to cope with a problem you've been
                  carrying around in your head for a while. Just being listened
                  to can help you feel supported and less alone. And it works
                  both ways. If you open up, it might encourage others to do the
                  same.
                </p>
              </div>
              ...
              <div>
                ...
                <p>
                  If you're seeking guidance or have inquiries about e-waste and
                  its implications, our knowledgeable chatbot is at your
                  service.
                </p>
              ...
              <div>
                ...
                <p>
                  We provide the best and the most trusted E-waste Facility
                  Locations to get the Trash turn into Treasure. To Locate the
                  E-waste Facility Locations near you , Go to the Locate.
                </p>
                {/* <button className="take-me-there-btn" id="chat-bot-page-portal-btn">Take me there <i className="fas fa-long-arrow-alt-right take-there-arrow"></i></button> */}
              </div>
            </div>

            <div className="take-page-img-cont"></div>
          </div>
        </div>
